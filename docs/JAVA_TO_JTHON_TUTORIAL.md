# Java 代码转 Python 代码教程

> 本项目 API 文档（item / block / McReflect / MinecraftClasses 等）请查看 [USAGE.md](USAGE.md)。
> 本教程专注于 Java → Python 的语法转换。

本教程介绍如何将 Java 代码转换为可在本模组中运行的 Python 代码，特别针对本 Minecraft Fabric 模组开发项目。
